    ...
    <body>
        <div class="wrap">
            <div class="form-wrap">
                ...
                <form method="post" action="CustomerLoginController" id="login" class="input-group">
                    <input type="text" class="input-field" placeholder="User name or Email" required>
                    <input type="password" class="input-field" placeholder="Enter Password" required>
                    <input type="checkbox" class="checkbox"><span>Remember Password</span>
                    <button class="submit">Login</button>
                </form>
                <form method="post" action="CustomerLoginController" id="register" class="input-group">
                <a href = "driver/driverJoinForm.jsp">운전자로 등록하기</a>
                    <input type="text" class="input-field" placeholder="Enter Id" required>
                    <input type="password" class="input-field" placeholder="Enter Password" required>
                    <input type="name" class="input-field" placeholder="Enter Name" required>
                    ...
                    <input type="phone" class="input-field" placeholder="Enter Phone-number" required>
